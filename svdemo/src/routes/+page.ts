...
export const load =  ( async () => {
  ...
  const initialQuery = 'SELECT+TOP+1000+source_id,ra,dec,parallax,nu_eff_used_in_astrometry+FROM+gaiadr3.gaia_source+WHERE+parallax>0.1+ORDER+BY+parallax+DESC';
