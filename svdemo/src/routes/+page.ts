...
export const load =  ( async () => {
  ...
  const initialQuery = 'SELECT+TOP+2000+source_id,ra,dec,parallax,teff_gspphot_upper,phot_g_mean_mag+FROM+gaiadr3.gaia_source+WHERE+parallax>0.1+ORDER+BY+parallax+DESC';
